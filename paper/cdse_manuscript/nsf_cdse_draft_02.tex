...
\csnote{it is consistent the 3rd value is the least among the 5 of them}
This can beaccounted to the increased communication required to transfer 
...
associated with the master process to obtain all the data since it has to 
wait for all the other processes to complete their task until it can obtain 
the data. This leads to a speed decrease when extra partitions in the y and 
z directions are present as this leads to more larger number of communications 
and wait times for the master process. \jhanote{this sentence does 

...
using particle-based models. Multi-scale, hybrid approaches represent a balancing
trade-off between the speed of bulk models and the high accuracy of
particulate models. In this work, a unidirectional multi-scale approach was
...
execution on high-performance platforms. Experimental results demonstrate
scaling from 1 to 128 cores for the PBM and up to 256 cores for the DEM. Our
...
but time is a good measure of performance. I do not see any data other than timing data for performance.} \\csnote{changed}

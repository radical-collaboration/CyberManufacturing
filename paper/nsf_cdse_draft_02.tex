...
shortest possible time and so that more detail can be used in modelling than was without the performance improvements of parallel computing. Specific goals include the 
following:
\begin{itemize}
...
MPI and OMP. The hybrid parallelisation helped achieve 
...
was 1mm - 3mm. The difference in the mechanics of these two simulations is discussed later in the Section \ref{sec:Results}. 

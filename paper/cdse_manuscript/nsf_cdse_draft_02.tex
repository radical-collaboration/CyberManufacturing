...
\newcommand{\jwave}[1]{#1}
%newcommand{\jhanote}[1]{ {\textcolor{red} { ***shantenu: #1 }}}
\newcommand{\jhanote}[1]{}
\newcommand{\csnote}[1]{}
\newcommand{\gpnote}[1]{}
\newcommand{\note}[1]{}
...
%No OMP threads were implemented for
...
%state of the simulation. But, this communication time was significantly lower than the total

...
class controllerPBMDataReader(object):
    ...
    def nextfile_time_finder(self, last_ts):
        ...
        num_end_particles = re.search(".csv",particles_file_list[0][num_start_particles:len(particles_file_list[0])]).start()
        num_end_particles = num_end_particles + num_start_particles
        ...
        num_end_d50 = re.search(".csv",d50_file_list[0][num_start_d50:len(d50_file_list[0])]).start()
        num_end_d50 = num_end_d50 + num_start_d50
    ...
    def data_particles_extractor(self, curr_ts):
        ...
        with open(filetoread_particles, 'rb') as particles_current_file:
            ...
            for x in range(1, ts_len):
                total_num_particles += float(read_particles.iloc[x][3])

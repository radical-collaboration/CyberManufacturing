...
//TUNING PARAMETERS
#define AGGREGATIONKERNELCONSTANT 1.0e-2//2.0e-2//8.0e-14 //5.0e-14//1e-12//3.75488281e-9//1.0//9.375e-4//1.0e-6 //1.0e-3 //240.0
...
#define BREAKAGEKERNELCONSTANT 1e-5//1e-2//5.0e-4 //5.0e-7 //5.0

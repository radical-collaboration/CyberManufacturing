...
resources by defining number of cores, HPC resource, and the total time that 
...
submit and monitor a Pilot. The Unit Manager is responsible to
...
the DEM simulation start executing. When finished, a CU describing a PBM
...
\gpnote{This paragraph tellsis very similar with the previous one. Can they become
    one?}

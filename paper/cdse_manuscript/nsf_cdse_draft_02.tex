...
technique as dicussed above. This code was compiled using the intel/15.0.2 and mvapich2/2.1 compilers. The code was tested on
...
prelimenary studies have been addressed in more detail in the supplemental information.
